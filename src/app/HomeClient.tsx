...
export default function HomeClient() {
  ...
  const heroMedia = [
    { type: "video", src: "/images/Children's_yoga_studio_interior_202607091317.mp4", alt: "Happy Fit Club Studio Promo" },
    { type: "video", src: "/images/Kid_holding_tablet,_doing_yoga_202607091315.mp4", alt: "From Screen Time to Yoga movement" },
